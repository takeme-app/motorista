...
type Props = NativeStackScreenProps<DependentShipmentStackParamList, 'DependentShipmentSuccess'>;
...
export function DependentShipmentSuccessScreen({ navigation }: Props) {
    ...
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: bottomInset }]}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.body}>
          Sua solicitação de envio para o dependente foi registrada. Você pode acompanhar o status em{' '}
...
const styles = StyleSheet.create({
  ...
  body: { fontSize: 14, color: COLORS.neutral700, textAlign: 'center', marginBottom: 24 },
