-- Inclui shipment_id nas entradas do resumo (para o app rotular "Taxa de entrega em dinheiro").
...
BEGIN
  ...
  SELECT coalesce(
    ...
    INTO v_entries
  FROM (
    SELECT id, booking_id, shipment_id, kind, amount_cents, note, created_at
