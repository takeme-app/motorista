-- Adiciona aviso de cancelamento por admin/sistema/expiração ao phase-change do
-- shipment (motivo != driver_ e != passenger_cancellation), antes só coberto
-- pelo genérico. Demais ramos e idempotência (status_change_notified) preservados.
